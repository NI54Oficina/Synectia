...
<section id="<?php echo $section_id; ?>" class="home-section-<?php echo ($i+1); ?> <?php echo $section_css_class;?>">
       ...
       <h1 class="section-title <?php echo $section_title_class; ?>"><?php echo $section_title; ?></h1>
		...
		for($c=0;$c<6;$c++){
		 ...
		 if( $link == "" )
	     $img_wrap = '<a href="'.$image.'" rel="onetone-portfolio-image"><img src="'.$image.'" alt="Portfolio Image '.($c+1).'"  class="feature-img "><div class="img-overlay dark">
	     ...
	     $img_wrap = '<a href="'.$link.'" target="'.$target.'"><img src="'.$image.'" alt="Portfolio Image '.($c+1).'" class="feature-img "><div class="img-overlay dark">
																			<div class="img-overlay-container">
																				<div class="img-overlay-content">

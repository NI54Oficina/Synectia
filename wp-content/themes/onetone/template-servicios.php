...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 body-servicios">
  ...
  <style>
  		.owl-item {display:table-cell;
  		float:none;
  		}
  		.owl-item img{vertical-align:top;}
  		.owl-item img{vertical-align:top;}
  		.especialidad-post-image .owl-nav{display:none;}
  		.mini-slider-pc img{position:absolute;transition:.5s;}
  		.mini-slider-pc img:first-child{z-index:10;}
  		.mini-slider-pc img:nth-child(2){opacity:0;}
  		.mini-slider-mobile .owl-dots{position:absolute;height:20px;z-index:30;width:100%;text-align:center;margin-top:-50px;}
  		.mini-slider-mobile .owl-dots .owl-dot{display:inline-block;}
  		.mini-slider-mobile .owl-dots .owl-dot:before{content:"•";display:inline-block;font-size:40px;color:#008e8e;opacity:0.5;}
  		.mini-slider-mobile .owl-dots .owl-dot.active:before{opacity:1;}

  		.mini-slider-pc .owl-dots{position:absolute;height:20px;z-index:30;width:100%;text-align:center;top:120px;}
  		.mini-slider-pc .owl-dots .owl-dot{display:inline-block;}
  		.mini-slider-pc .owl-dots .owl-dot:before{content:"•";display:inline-block;font-size:40px;color:#008e8e;opacity:0.5;}
  		.mini-slider-pc .owl-dots .owl-dot.active:before{opacity:1;}
  		</style>
  ...
  foreach($posts as $post){  ?>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12"  >
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background-color:white; padding:0;">
        <div id="mini-slider-<?php echo $indexP++;?>" class="especialidad-post-image mini-slider-mobile hidden-lg hidden-md" style="position:relative;" hover="0">
    ...
    foreach($imagenes as $image){
      ?><img src="<?php echo $image; ?>" /><?php
        ...
        <div id="" class="especialidad-post-image mini-slider-pc hidden-xs hidden-sm" style="position:relative;" hover="0">
          <?php //the_post_thumbnail('full'); ?>
          <?php
